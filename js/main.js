...
var simpl = {
  ...
  fillPopUp: function(popUpType, fn) {
    ...
    if(popUpType === 'setlimit-pop-up') {
      popUpDiv.innerHTML =
      '<div class="pop-up__wrapper">' +
        '<p class="pop-up__p">Set your day limit<br> 1 - 99999</p>' +
        '<div class="pop-up__field-wrapper">' +
          '<input type="number" class="pop-up__field" id="setlimit-field" min="1" max="99999" step="1" autofocus>' +
        '</div>' +
    ...
    if(popUpType === 'setexpense-pop-up') {
      ...
      '<div class="pop-up__wrapper">' +
        ...
        '<div class="pop-up__field-wrapper">' +
          '<input type="number" class="pop-up__field" id="setexpense-value-field" min="1" max="99999" step="1" value="" autofocus>' +
        '</div>' +
